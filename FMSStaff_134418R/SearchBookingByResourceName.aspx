<%@ Page Title="" Language="C#" MasterPageFile="~/FMS_Master.master" AutoEventWireup="true" CodeFile="SearchBookingByResourceName.aspx.cs" Inherits="SearchBooking" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<h1>Search booking by Resource Name</h1>
    Resource Name:
    <asp:TextBox ID="ViewBookingByResourceTypeTextBox" runat="server"></asp:TextBox>
    <br />
    ...
    <asp:SqlDataSource ID="BookingSqlDataSource" runat="server" 
        ...
        SelectCommand="SELECT Booking.StaffId, Booking.Location, Booking.BookingDate, Booking.Purpose, StartTime.StartTime, EndTime.EndTime, Staff.StaffName, Resource.Description FROM Booking INNER JOIN Staff ON Booking.StaffId = Staff.StaffId INNER JOIN Resource ON Booking.Location = Resource.Location INNER JOIN StartTime ON Booking.StartTimeId = StartTime.id INNER JOIN EndTime ON Booking.EndTimeId = EndTime.id WHERE (Resource.Description = @description)">
        <SelectParameters>
            <asp:ControlParameter ControlID="ViewBookingByResourceTypeTextBox" 
