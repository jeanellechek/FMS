<%@ Page Title="" Language="C#" MasterPageFile="~/FMS_Master.master" AutoEventWireup="true" CodeFile="SearchBookingByResourceType.aspx.cs" Inherits="SearchBooking" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<h1>Search booking by Resource Type</h1>
    Type:
    <asp:TextBox ID="ViewBookingByResourceTypeIDTextBox" runat="server"></asp:TextBox>
    <br />
    ...
    <asp:SqlDataSource ID="BookingSqlDataSource" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="ViewBookingByResourceTypeIDTextBox" 
                Name="type" PropertyName="Text" />
        </SelectParameters>
    </asp:SqlDataSource>
    <br />
</asp:Content>
